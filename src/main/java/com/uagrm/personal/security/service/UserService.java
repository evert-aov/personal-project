...
import com.uagrm.personal.security.dto.UserCreateDto;
import com.uagrm.personal.security.dto.UserResponseDto;
import com.uagrm.personal.security.dto.UserUpdateDto;
import com.uagrm.personal.security.mapper.UserMapper;
...
public class UserService {
    ...
    public UserResponseDto userCreate(UserCreateDto userCreate) {
        ...
        if (userCreate.username() == null || userCreate.username().isBlank())
            throw new RuntimeException("Error: username is required.");

        if (userRepository.existsByUsername(userCreate.username()))
            throw new RuntimeException("Error: username '" + userCreate.username() + "' is already taken.");
